...
} from "../AdminAction/coursesAdminActions";
...
export default function Courses() {
  ...
  const { arrCoursesAdmin } = useSelector((state: any) => state.CoursesAdminReducer);
  ...
  return (
    <Fragment>
      <div style={{paddingLeft:'100px',paddingTop:'50px',paddingBottom:'50px' }} className="py-12">
        <div className="max-w-7xl flex flex-row items-center justify-between mx-auto px-4 xl:px-0 sm:px-6 md:px-8">
          <div>
            <h3 style={{paddingBottom:'50px'}} className="text-4xl">2.Quản lý khoá học</h3>
          </div>
